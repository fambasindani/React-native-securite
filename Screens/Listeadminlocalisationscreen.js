...
const Listeadminlocalisationscreens = ({ navigation }) => {
  ...
  const fetchUserData = async () => {
   ...
   const nextpage=currentpage+1;
    ...
    try {
      ...
      const urls = ApiUrl({ endpoint: `getadminalertpage` });
    ...
    <View style={styles.complet}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.searchContainer}>
          ...
          <Listeadminlocalisation  mydata={filteredData}  fetchUserData={fetchUserData}   SetLoading={SetLoading} Loading={Loading}  handleConfirm={handleConfirm}   />
...
export default Listeadminlocalisationscreens;