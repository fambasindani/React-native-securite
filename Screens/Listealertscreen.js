...
const Listealertscreen = ({ navigation }) => {
  ...
  const fetchUserData = async () => {
   ...
   const nextpage=currentpage+1;
    ...
    try {
      ...
      const urls = ApiUrl({ endpoint: `getalertpage/${userids }` });
    ...
    <View style={styles.complet}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.searchContainer}>
          ...
          <Listealerte  mydata={filteredData}  fetchUserData={fetchUserData}   SetLoading={SetLoading} Loading={Loading}  handleConfirm={handleConfirm}   />
...
export default Listealertscreen;