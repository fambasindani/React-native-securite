...
const Listeadminalert = ({ mydata, SetLoading, handDelete,handupdate, Loading, fetchUserData, handleConfirm }) => {
      ...
      <View style={styles.itemContainer}>
        ...
        <View style={styles.descriptionContainer}>
          <View style={styles.nameContainer}>
            <Text style={styles.lastName}>{truncateText(item.contenu,19)}</Text>
...
export default Listeadminalert;